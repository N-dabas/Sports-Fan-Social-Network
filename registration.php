...
<input type="text" name="lastname" placeholder='Last Name' pattern="[A-Za-z]+" required> 
    ...
    <br><br>
DOB:<input type="date" name="dob" id="datepicker" placeholder='DOB(YYYY-MM-DD)' min="1950-05-11" max="<?php echo date("Y-m-d") ?>" required > 
    ...
    <br> <br>
<input type="text" name='uname' placeholder='UserName' pattern="[A-Za-z]+" required> 
...
<input type="password" name='conpassword' id="pass2" placeholder='Confirm Password' pattern=".{6,}" title="Six or More characters" required>
    ...
    <br><br>
Profile Picture:   <input style="padding-left:600px" type="file" name="file" accept='.png,.jpg' value='Upload Picture' />
    <br>
