...
UNION SELECT friends.userid_2 as ids FROM friends WHERE friends.userid_1 =$_SESSION[user_id] and friends.action=1 )) and diary.Status_d=1 and diary.privacy_d not in (3) order by diary.created_date desc"; 
